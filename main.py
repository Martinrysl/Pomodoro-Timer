...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        label_timer.config(text="Break",  font=(FONT_NAME, 35, 'bold'), fg=RED, bg=YELLOW)
    elif reps % 2 == 0:
        count_down(short_break_sec)
        label_timer.config(text="Break", font=(FONT_NAME, 35, 'bold'), fg=PINK, bg=YELLOW)
    else:
        count_down(work_sec)
        label_timer.config(text="Work", font=(FONT_NAME, 35, 'bold'), fg=GREEN, bg=YELLOW)
